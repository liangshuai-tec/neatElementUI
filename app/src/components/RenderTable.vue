...
<!-- 
 ...
 -->
        <el-table ref="table" :data="data" v-on="$listeners" v-bind="$attrs" @selection-change="selectionChangeFunc">
...
/* eslint-disable */
import {Button, Form, FormItem, Row, Col, Input, Select, Option, DatePicker, Table, TableColumn} from "element-ui"
